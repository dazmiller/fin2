...
<head>
    ...
    <title>NoHassl. Taking all the hassle out of getting quotes and services</title>
    ...
    <div id="contact-popup">
        ...
        <div id="contact-popup-content" class="animated speed">
            ...
            <div class="padding">
                ...
                <h3>Contact us</h3>
                <h3 class="right">(+61) 424 608 973</h3>
    ...
    <div id="quote-popup">
        ...
        <div id="quote-popup-content" class="animated speed">
            ...
            <ul id="quote-popup-tabs">
                ...
                <li data-quote-tab-for="house-insurance">Health insurance</li>
                <li data-quote-tab-for="car-insurance">Vehicle insurance</li>
                <li data-quote-tab-for="life-insurance">Home insurance</li>
                <li data-quote-tab-for="travel-insurance">Travel insurance</li>
                <li data-quote-tab-for="life-insurance">Pet insurance</li>  
                <li data-quote-tab-for="house-insurance">Funeral insurance</li>
                        ...
                        <ul class="submenu animated speed fadeInDown">
                            ...
                            <li>
                                ...
                                <ul class="submenu animated speed fadeInRight">
                                    ...
                                    <li><a href="get-a-travel-insurance-quote.php">Health insurance Quote</a></li>
                                    <li><a href="get-a-travel-insurance-quote.php">Pet insurance Quote</a></li>
                                    <li><a href="get-a-travel-insurance-quote.php">Funeral insurance Quote</a></li>
                                </ul>
                            
                            </li>
                            
                            <li><a href="claims.php">Quotes</a></li>
                            ...
                            <li>
                                ...
                                <ul class="submenu animated speed fadeInRight">
                                    ...
                                    <li><a href="travel-insurance.php">Health insurance Quote</a></li>
                                    <li><a href="travel-insurance.php">Pet insurance Quote</a></li>
                                    <li><a href="travel-insurance.php">Funeral insurance Quote</a></li>
        ...
        <div class="heading-slides">
            ...
            <div class="heading-slide-single" data-slide-id="1" style="background-image: url( '_assets/_img/pretty-woman-in-office.jpg' );">
                ...
                <div class="flying-1">
                    ...
                    <span>Easy Insurance</span>
                
                </div>
                
                <div class="flying-2">
                
                    <h3>Life insurance<br /> for your family</h3>
                    <p>The easiest and quickest way to get the best quotes.</p>
                ...
                <div class="heading-content">
                    ...
                    <h2>Insurance is important</h2>
                    <h3>Dont waste time chasing them<br /> make them chase you.</h3>
            ...
            <div class="heading-slide-single" data-slide-id="2" style="background-image: url( '_assets/_img/happy-couple-in-cafe-using-digital-tablet.jpg' );">
                ...
                <div class="flying-2">
                    ...
                    <h3>Health insurance<br /> for you & your family</h3>
                    <p>Take all the hassle out of getting or changing health insurance.</p>
                ...
                <div class="heading-content">
                    ...
                    <h2>Health Insurance does matter</h2>
                    <h3>Life is too short to waste time on the phone<br /> make the insurers work to get your business.</h3>
    ...
    <section class="insurances-slider section-gray">
        ...
        <div class="center">
            ...
            <div class="images">
                ...
                <div class="image" style="background-image: url( '_assets/_img/walking-garden-dog-outside.jpg' );" data-insurance-key="pets">
                </div>
            ...
            <div class="content">
                ...
                <div class="descriptions">
                    ...
                    <div class="description" data-insurance-key="pets">
